...
# create_matrix        create matrix TermDocuments, useful for the functions: myClassEmotion e myClassPolarity
# myClassEmotion       Computing emotions with the NaiveBayes method
# myClassPolarity      Compute polarity (negative or positive) with the NaiveBayes method 
# my_get_nrc_sentiment Compute emotions and polarity with syuzhet alghoritm
##sentiMediaDiz        Computing polarity with function txt_sentiment from udpipe on a list of dictionaries defined by us
...
{
#  print("creating DocumentTermMatrix")
#  cat("\n")
  require(svMisc)
...
# -----------------------------------------------------------------------------------------
# Sentiment function from the library syuzhet for sentiment on a dictionary of personal polarity
#
